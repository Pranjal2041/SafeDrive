...
public class SceneLoader implements LoadListener, EventListener {
    ...
    private Map<Integer, RenderingColorClass> colorMapping;

    public Map<Integer, RenderingColorClass> getColorMapping() {
        return colorMapping;
    }

    public void setColorMapping(Map<Integer, RenderingColorClass> colorMapping) {
        this.colorMapping = colorMapping;
    }

    public SceneLoader(Activity main, URI uri, int type, GLSurfaceView glView, Map<Integer, RenderingColorClass> colorMapping) {
        this.parent = main;
        this.uri = uri;
        this.type = type;
        this.glView = glView;
    ...
    public final void changeWireframe(int drawwMode){
        this.drawwMode = drawwMode +3;
        toggleWireframe();
    }
