...
public class WavefrontLoader {
    ...
    public List<Object3DData> load(URI modelURI, Activity activity) {
        try {
            ...
            final InputStream is = activity.getAssets().open("models/3.obj");//modelURI.toURL().openStream();
            ...
            for (MeshData meshData : meshes) {
                ...
                loadMaterials(meshData,activity);
    ...
    private void loadMaterials(MeshData meshData,Activity activity) {
...
//            final InputStream inputStream = ContentUtils.getInputStream(meshData.getMaterialFile());
            final InputStream inputStream = activity.getAssets().open("models/2.mtl");//modelURI.toURL().openStream();
